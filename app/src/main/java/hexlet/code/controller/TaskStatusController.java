...
public class TaskStatusController {
    ...
    public TaskStatusDTO create(@RequestBody @Valid final TaskStatusCreateDTO data) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public TaskStatusDTO update(@PathVariable final long id, @RequestBody @Valid final TaskStatusUpdateDTO data) {
        var taskStatus = taskStatusRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Not Found: " + id));
